...
/**
 * 客服机器人示例
 * 演示如何用不同消息类型构建专业对话（使用 DeepSeek 模型）。
 */
...
async function main() {
  ...
  console.log(`🤖 客服: ${response1.content as string}`);
  ...
  console.log(`🤖 客服: ${response2.content as string}`);
  ...
  console.log(`🤖 客服: ${response3.content as string}`);
